...
We as members, contributors, and leaders pledge to make participation in the Oz AI project a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socioeconomic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all project spaces — including the GitHub repository, issue tracker, pull requests, and any other communication channels associated with the Oz AI project. It also applies when an individual is officially representing the project in public spaces.
